...
//    public void shouldGetBookDiscounts(String query, String priceFrom, String priceTo, int genreId, Pageable pageable) throws Exception {
//        // Given
//        Book book = new Book();
//        book.setId(12L);
...
//
//        // When
//        Page<BookDiscountView> bookDiscounts = controller.getBookDiscounts(query, priceFrom, priceTo, genreId, pageable);
//
//        // Then
...
//
//    @Test(dataProvider = "searchParamsProvider")
//    public void shouldReturnEmptyPageForNoDiscountsGetFromRepo(String query, String priceFrom, String priceTo, int genreId, Pageable pageable) {
//        // Given

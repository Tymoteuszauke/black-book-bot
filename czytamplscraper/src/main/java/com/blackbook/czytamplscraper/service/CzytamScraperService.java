...
@Slf4j
@Service
public class CzytamScraperService implements BotService {
    ...
    @Autowired
    public CzytamScraperService(Collector collector, ScheduledExecutorService scheduledExecutorService) {

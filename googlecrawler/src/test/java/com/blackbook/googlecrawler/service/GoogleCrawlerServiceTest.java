 ...
 */
public class GoogleCrawlerServiceTest {
    ...
    public void prepareData(){
        ...
        failedMockResponse = new ResponseEntity<SimpleResponse<String>>(new SimpleResponse<>("Failed test response"),
    ...
    public void testStart(){
        ...
        GoogleCrawlerService service = new GoogleCrawlerService(crawler, mockedExecutorService);
    ...
    public void testDataSuccessSending() throws ExecutionException, InterruptedException {
        ...
        GoogleCrawlerService service = new GoogleCrawlerService(crawler, executorService);

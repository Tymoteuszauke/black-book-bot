...
@Slf4j
@Service
public class GandalfScraperService implements BotService {
    ...
    @Autowired
    public GandalfScraperService(Collector collector, ScheduledExecutorService scheduledExecutorService) {
